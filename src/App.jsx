  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-3 sm:px-4 py-5 space-y-4">
        ...
        {/* Listado Agrupado Estilo Tabla Excel */}
        {totalResults > 0 ? (
          <div className="space-y-4">
            {Object.entries(groupedServices).map(([categoryName, items]) => (
              ...
              >
                {/* Encabezado del Grupo (Estilo Excel) */}
      ...
      <footer className="text-center py-4 text-xs text-slate-400 border-t border-slate-200 bg-white mt-6">
